...
urlpatterns = [
    # url(r'^$', views.construct_dashboard_home, name="dashboard_home"),
    ...
    url(r'^submission/(?P<username>[\w@.\-_+]+)/$', views.construct_dashboard_submission_single, name="submission_single"),
